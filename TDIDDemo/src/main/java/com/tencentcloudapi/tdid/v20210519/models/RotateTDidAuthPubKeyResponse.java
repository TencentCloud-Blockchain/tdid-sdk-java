...
public class RotateTDidAuthPubKeyResponse extends AbstractModel{
    ...
    */
    ...
    public RotateTDidAuthPubKeyResponse() {
    }
     ...
     */
    public RotateTDidAuthPubKeyResponse(RotateTDidAuthPubKeyResponse source) {
